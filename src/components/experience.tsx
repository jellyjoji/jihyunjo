...
export function Experience() {
  const experiences = [
    {
      title: "Senior Full Stack Developer & UX/UI Designer",
      ...
      description: [
        ...
        "Designed and implemented UI components, worked closely with product teams to improve usability and accessibility",
      ],
    },
    {
